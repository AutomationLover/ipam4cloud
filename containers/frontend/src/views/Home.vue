        ...
        <el-card class="welcome-card">
          <template #header>
            <div class="card-header">
              <span>Prefix Management System</span>
            </div>
          </template>
          <div class="welcome-content">
            <h2>Welcome to the Prefix Management System</h2>
            <p>This system helps you manage hierarchical IP prefixes for cloud environments.</p>
            ...
            <el-row :gutter="20" class="feature-cards">
              <el-col :span="8">
                <el-card shadow="hover" class="feature-card">
                  ...
                  <p>View and manage IP prefixes in both list and tree views. Create child prefixes and associate them with VPCs.</p>
              ...
              <el-col :span="8">
                <el-card shadow="hover" class="feature-card">
                  ...
                  <p>Manage Virtual Routing and Forwarding instances that organize your network prefixes.</p>
              ...
              <el-col :span="8">
                <el-card shadow="hover" class="feature-card">
                  ...
                  <p>View and manage cloud VPCs from different providers (AWS, Azure, GCP).</p>
